    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form id="admin-form" name="addForm" action="${pageContext.request.contextPath}/ProductServlet?method=update" enctype="multipart/form-data" method="post">
...
<%--                                        <option value="10001" selected="selected">分类一</option><option value="10002">财务部</option><option value="10003">事业部</option>--%>
                                    </select>
